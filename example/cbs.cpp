...
struct Constraints {
  std::/*unordered_*/set<VertexConstraint> vertexConstraints;
  std::/*unordered_*/set<EdgeConstraint> edgeConstraints;
...
class Environment {
 public:
  Environment(size_t dimx, size_t dimy, std::/*unordered_*/set<Location> obstacles,
...
//  Environment(const Environment&) = delete;
 ...
 private:
  int m_dimx;
  int m_dimy;
  std::/*unordered_*/set<Location> m_obstacles;
...
int main(int argc, char* argv[]) {
  ...
  ("threads,t",po::value<int>(&threadsNum)->default_value(4),
   "Number of Threads");
  ...
  std::/*unordered_*/set<Location> obstacles;
  ...
  CBS<State, Action, int, Conflict, Constraints, Environment> cbs(mapf, startStates, solution, threadsNum);
